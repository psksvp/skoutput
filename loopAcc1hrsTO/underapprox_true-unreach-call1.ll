; ModuleID = '/home/psksvp/workspace/sv-bench/c/loop-acceleration/underapprox_true-unreach-call1.c'
...
; <label>:10                                      ; preds = %2
  %11 = load i32, i32* %y, align 4, !dbg !26
  %12 = urem i32 %11, 3, !dbg !27
  %13 = icmp ne i32 %12, 0, !dbg !27
  br i1 %13, label %15, label %14, !dbg !28

; <label>:14                                      ; preds = %10
  call void (...) @__VERIFIER_error() #2, !dbg !29
  unreachable, !dbg !29

; <label>:15                                      ; preds = %10
  %16 = load i32, i32* %1, !dbg !30
  ret i32 %16, !dbg !30
}
...
!1 = !DIFile(filename: "/home/psksvp/workspace/sv-bench/c/loop-acceleration/underapprox_true-unreach-call1.c", directory: "/home/psksvp/workspace/skink")
!2 = !{}
!3 = !{!4, !6}
...
!26 = !DILocation(line: 20, column: 8, scope: !6)
!27 = !DILocation(line: 20, column: 10, scope: !6)
!28 = !DILocation(line: 20, column: 6, scope: !6)
!29 = !DILocation(line: 20, column: 16, scope: !22)
