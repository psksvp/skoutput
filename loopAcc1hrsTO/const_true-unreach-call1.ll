; ModuleID = '/home/psksvp/workspace/sv-bench/c/loop-acceleration/const_true-unreach-call1.c'
...
; <label>:2                                       ; preds = %5, %0
  ...
  %4 = icmp ult i32 %3, 1024, !dbg !23
  br i1 %4, label %5, label %8, !dbg !19

; <label>:5                                       ; preds = %2
  store i32 0, i32* %x, align 4, !dbg !24
  %6 = load i32, i32* %y, align 4, !dbg !25
  %7 = add i32 %6, 1, !dbg !25
  store i32 %7, i32* %y, align 4, !dbg !25
  br label %2, !dbg !19

; <label>:8                                       ; preds = %2
  %9 = load i32, i32* %x, align 4, !dbg !26
  %10 = icmp ne i32 %9, 0, !dbg !27
  br i1 %10, label %11, label %12, !dbg !26
...
!1 = !DIFile(filename: "/home/psksvp/workspace/sv-bench/c/loop-acceleration/const_true-unreach-call1.c", directory: "/home/psksvp/workspace/skink")
!2 = !{}
!3 = !{!4, !6}
...
!25 = !DILocation(line: 16, column: 6, scope: !6)
